...
pare em cada um para review. Siga o `AGENTS.md` e o `ANTI-PADROES.md`. **Dono:** `@sm` (cria
`tasks.md`), `@dev` (implementa). Não invente — ver "Verificação de conhecimento" no `AGENTS.md`.
