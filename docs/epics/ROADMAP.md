...
| E01-S12 | Visão 360 do Cliente — página read-only por condomínio (v1: cadastro + backlog GUT + histórico de OS; +técnicos/equipamentos se E01-S11 fechar). PMOC/ativos/financeiro/WhatsApp adiados p/ fase 2 | [product](../../specs/E01-S12-visao-360-cliente/product.md) | **product.md pronto, aguardando @architect/aprovação** — 3 perguntas de negócio em aberto (abrir v1 agora? onde mora na nav? quem vê qual cliente?) | Claude (sessão Lucas) | — |
