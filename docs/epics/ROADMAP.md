...
| E01-S22 | Motor de sync Auvo (write path) — outbox transacional `pcm.auvo_sync_outbox` + drain genérico `pcm-auvo-push` + scaffold do entity registry + `auvoPatch`/`auvoDelete`. Tier arquitetural, ADR-0005 | [product](../../specs/E01-S22-motor-sync-auvo-write/product.md) · [design](../../specs/E01-S22-motor-sync-auvo-write/design.md) · [domain](../../specs/E01-S22-motor-sync-auvo-write/domain.md) · [spec](../../specs/E01-S22-motor-sync-auvo-write/spec.md) · [tasks](../../specs/E01-S22-motor-sync-auvo-write/tasks.md) | Spec/tasks prontas — implementação iniciando | Claude (sessão Lucas) | ⏳ |
