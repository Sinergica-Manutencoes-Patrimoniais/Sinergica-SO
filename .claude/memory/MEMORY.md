...
---
> **Para devs:** estes arquivos são a memória do agente Claude para este projeto.
> Ao clonar o repo, copie `.claude/memory/` para:
> `~/.claude/projects/-Users-<seuusuario>-Documents-GitHub-Sinergica-Sinergica-OS/memory/`
> Ou symlink: `ln -s $(pwd)/.claude/memory ~/.claude/projects/<path>/memory`
