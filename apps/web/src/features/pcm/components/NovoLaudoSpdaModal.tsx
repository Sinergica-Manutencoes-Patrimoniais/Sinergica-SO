    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 p-3 md:p-4">
      ...
      >
        <header className="border-b border-line-soft bg-card px-4 py-3 md:px-5">
          <div className="flex items-start justify-between gap-3">
            <button
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-line text-ink-3 hover:bg-line-soft hover:text-ink"
        ...
        <div className="overflow-y-auto bg-paper p-4 md:p-5">
          ...
          <section className="mx-auto max-w-4xl rounded-lg bg-navy p-4 text-white md:p-6">
            {etapa.id === "dados" && (
              ...
              <div key={ponto.id} className="rounded-lg border border-white/15 bg-card/5 p-4">
                <div className="mb-3 flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-white/15 text-white/55 hover:bg-card/10 hover:text-white"
