  ...
  if (user?.papel !== "superadmin") {
    return (
      <div className="p-12 text-center">
        ...
        <p className="mt-1 text-body text-ink-3">Só superadmin configura a localização Auvo.</p>
      </div>
    );
  }
      ...
      {carregando ? (
        ...
        <section className="rounded-xl border border-line bg-card p-4">
          <div className="flex items-center gap-2 border-b border-line-soft pb-3">
            ...
            <h3 className="text-body font-semibold text-ink">Separador e ordem</h3>
          </div>

          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <label className="block">
              <span className="mb-1 block text-caption font-semibold text-ink-3">Separador</span>
              <input
                type="text"
            ...
            <label className="block">
              <span className="mb-1 block text-caption font-semibold text-ink-3">Ordem</span>
              <select
                className="input w-full"
          ...
          <div className="mt-4 rounded-md border border-line bg-paper px-3 py-2">
            ...
            <p className="mt-1 text-body font-semibold text-ink">{preview || "—"}</p>
          </div>
