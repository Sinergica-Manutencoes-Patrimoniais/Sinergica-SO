    ...
    <div className="flex flex-col gap-4">
      <section className="rounded-lg border border-line bg-card p-4 shadow-raised">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <h1 className="text-heading font-semibold text-ink">Régua de cobrança</h1>
                ...
                <div className="flex justify-end gap-2">
                  ...
                  {temEscrita && ponto.ativo && (
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-caption font-semibold text-danger hover:text-danger"
                    >
      ...
      <section className="rounded-lg border border-line bg-card p-4">
        <h3 className="text-heading font-semibold text-ink">Histórico de envios</h3>
        <p className="mt-0.5 text-body text-ink-3">
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <label className="block">
          <span className="mb-1 block text-caption font-semibold text-ink-3">Canal *</span>
          <select
            value={canal}
