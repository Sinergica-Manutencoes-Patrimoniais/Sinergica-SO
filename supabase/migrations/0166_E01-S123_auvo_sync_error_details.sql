-- 0166_E01-S123_auvo_sync_error_details.sql — Sinérgica SO
-- Drill-down controlado dos últimos erros da outbox. A tabela continua exclusiva do service_role;
-- esta view expõe somente entidade, id local, mensagem já higienizada e horário ao PCM autorizado.
...
comment on view pcm.auvo_sync_error_details is
  'Último erro Auvo por entidade e registro, com detalhe seguro para a UI (E01-S123).';
