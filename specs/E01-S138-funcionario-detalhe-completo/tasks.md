...
| 2 | Domínio: agregações (contagem de OS por período, alocação da semana) puras/testáveis | AC-2,AC-3 | vitest | done |
| 3 | UI: perfil/detalhe do funcionário com as 4 seções + atalhos (lista de OS, histórico ferramenta) | AC-1..AC-4 | typecheck | done |
| 4 | Estados vazios + degradação (inativo, sem Auvo) | AC-5,AC-borda | vitest | done |
