...
| 3 | Remover o grupo PREVENTIVO (Cronograma/Preventivas — itens mortos sem `view`) | AC-3 | typecheck | done |
| 4 | Confirmar zero `view`/rota órfã apontando pra itens removidos; ajustar testes de nav | AC-4 | vitest/biome | done |
