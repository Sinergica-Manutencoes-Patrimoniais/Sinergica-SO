...
| 2 | Application/adapters: buscar OS/chamados/horas/agenda/saúde por data | AC-1,AC-2 | typecheck | done |
| 3 | UI `RelatorioDiarioPage` (grupo RELATÓRIOS): seletor de data + render das seções | AC-1,AC-4 | typecheck | done |
| 4 | Exportar PDF (`pdf-lib`) com o mesmo conteúdo | AC-3 | typecheck | done |
| 5 | Estado "sem movimento" + fallbacks (nome técnico/cliente, saúde indisponível) | AC-4 | vitest | done |
