...
|----|------|----------|----------------|--------|
| 1 | Adapter/application: listar TODOS os técnicos ativos + posse atual + histórico por técnico | AC-1,AC-2 | typecheck | todo |
| 2 | UI: lista de todos os técnicos com resumo (posse, divergência Auvo) | AC-1 | typecheck | todo |
