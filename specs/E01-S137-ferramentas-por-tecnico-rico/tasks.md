...
| 3 | Componente transfer-list (dual-list: disponíveis ↔ posse do técnico), com busca/filtro | AC-3,AC-4 | vitest | done |
| 4 | Modal do técnico: info + ferramentas atuais + histórico + transfer-list; atribuir/devolver em lote | AC-2,AC-3,AC-4,AC-5 | typecheck | done |
| 5 | Guardas: só-leitura sem escrita; unidade de outro técnico não transferível; regra "só disponível atribui" | AC-5,AC-borda | vitest | done |
